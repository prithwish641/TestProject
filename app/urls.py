...
urlpatterns = [
    ...
    path('card-detail/<int:pk>', views.CardDetailView.as_view(), name='card-detail'),
    path('add-to-cart/', views.add_to_cart, name='add-to-cart'),
    path('cart/', views.show_cart, name='showcart'),
    path('customr_care/', views.customer_care, name='customer_care'),
    path('pluscart/', views.plus_cart, name='plus_cart'),
    path('minuscart/', views.minus_cart, name='minus_cart'),
    path('removecart/', views.remove_cart, name='remove_cart'),
    path('add-to-buy/', views.add_to_buy, name='add-to-buy'),
    ...
    path('search_products/', views.search_options, name='search_options'),
